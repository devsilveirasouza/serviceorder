...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-center text-white" href="#">Ordem de Serviço</a>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="sidebarMenuLabel">SYSTEM</h5>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 bg-image">
                ...
                <style>
                    .bg-image {
                    background-image: url("{{ asset('images/bg-mechanic.jpg') }}");
