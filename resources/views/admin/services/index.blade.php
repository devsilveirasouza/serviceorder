        ...
        <div class="p-1">
            <div class="card-body">
                <div class="container mt-5">
                    <h3 class="mb-4">Lista de Serviços
                        <a href="{{ route('services.create') }}" class="btn btn-primary float-end">Novo</a>
                    </h3>
                    <!-- Inicio do Toast ==================================================================================== -->
                    <!-- Toast HTML -->
                    ...
                    <table id="index-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('services.show', $service) }}" class="btn btn-sm btn-primary"><i class="fa-solid fa-eye"></i></a>
                                    <a href="{{ route('services.edit', $service) }}" class="btn btn-sm btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
